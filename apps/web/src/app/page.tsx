      ...
      <section className="grid items-end gap-12 lg:grid-cols-[1.35fr_0.65fr]">
        <div>
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-300">
            ...
            progress into one focused workspace. This first runnable foundation
            keeps the architecture simple and ready to grow.
          </p>
        ...
        <aside className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-emerald-950/30">
          <div className="flex items-center justify-between">
            <p className="font-semibold text-white">Foundation status</p>
